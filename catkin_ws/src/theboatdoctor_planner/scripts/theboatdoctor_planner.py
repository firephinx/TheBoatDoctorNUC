...
class TheBoatDoctorController:
	def __init__(self):
		## Tuning Parameters
		self.raspberry_pi_camera_vertical_station_x_offset = -0.2
		self.raspberry_pi_camera_vertical_station_z_offset = -0.06
		self.vertical_station_goal_x_offset = -0.086
		self.vertical_station_goal_z_offset = 0.01
		self.raspberry_pi_camera_horizontal_station_x_offset = -0.2
		self.raspberry_pi_camera_horizontal_station_z_offset = 0.06
		self.horizontal_station_goal_x_offset = -0.03
		self.horizontal_station_goal_z_offset = 0.1
    ...
    def generate_robot_trajectory_using_ik(self):
        ...
        if(self.station_orientation == "vertical"):
                self.raspberry_pi_camera_position[0] = self.raspberry_pi_camera_position[0] + self.raspberry_pi_camera_vertical_station_x_offset
                self.raspberry_pi_camera_position[2] = self.raspberry_pi_camera_position[2] + self.raspberry_pi_camera_vertical_station_z_offset
        elif(station_orientation == "horizontal"):
                self.raspberry_pi_camera_position[0] = self.raspberry_pi_camera_position[0] + self.raspberry_pi_camera_horizontal_station_x_offset
                self.raspberry_pi_camera_position[2] = self.raspberry_pi_camera_position[2] + self.raspberry_pi_camera_horizontal_station_z_offset
        else:
        ...
        if(self.station_orientation == "vertical"):
            self.joint_angles_for_intermediate_position[2] = self.joint_angles_for_intermediate_position[2] - self.raspberry_pi_camera_vertical_station_z_offset + self.vertical_station_goal_z_offset
            self.joint_angles_for_goal_position[1] = self.joint_angles_for_goal_position[1] - self.raspberry_pi_camera_vertical_station_x_offset + self.vertical_station_goal_x_offset
            self.joint_angles_for_goal_position[2] = self.joint_angles_for_goal_position[2] - self.raspberry_pi_camera_vertical_station_z_offset + self.vertical_station_goal_z_offset
        else:
            self.joint_angles_for_intermediate_position[1] = self.joint_angles_for_intermediate_position[1] - self.raspberry_pi_camera_horizontal_station_x_offset + self.horizontal_station_goal_x_offset
            self.joint_angles_for_goal_position[1] = self.joint_angles_for_goal_position[1] - self.raspberry_pi_camera_horizontal_station_x_offset + self.horizontal_station_goal_x_offset
            self.joint_angles_for_goal_position[2] = self.joint_angles_for_goal_position[2] - self.raspberry_pi_camera_horizontal_station_z_offset + self.horizontal_station_goal_z_offset
    ...
    def verify_task_is_completed(self):
    	self.tbd_cv2 = TheBoatDoctorCV(actuator)
